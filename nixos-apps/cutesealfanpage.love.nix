...
in
{
  ...
  systemd.services = {
    cutesealfanpage-hakyll-site = {
      ...
      serviceConfig = {
        ExecStart = "nix run git+https://github.com/billewanick/seal-blog.git#hakyll-site -- watch --no-server";
      };
    };
    ...
    cutesealfanpage-generatePosts = {
      ...
      startAt = "08:12:42";
      serviceConfig = {
        ExecStart = "nix run git@github.com:billewanick/sealPostGenerator.git";
      };
    };
  };
